...
```sh
  cd my-folder
  git clone https://github.com/BryteLitty/rails-blog-app.git
```
...
- Twitter: [@brytelity](https://twitter.com/BryteLitty)
- LinkedIn: [Bright Kportiklah](https://www.linkedin.com/in/brightkportiklah)
